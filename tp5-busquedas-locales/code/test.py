...
g = gen.genetic(pop, fitness_fn, prob, select_fn, crossover_fn, mutate_fn, cull_fn, verbose=True)
print(g)
prob.print_board(g[0])
print(f"fitness: {fitness_fn(g[0])}, heuristic: {prob.heuristic_cost(g[0])}")
